...
- Target local path on Marina's machine: `S:\Studdy` (NTFS VHDX mounted from `E:\ExternalStorage\StuddyDev.vhdx`; do NOT work in `E:\ExternalStorage\Projects\Studdy` — exFAT, no symlinks).
